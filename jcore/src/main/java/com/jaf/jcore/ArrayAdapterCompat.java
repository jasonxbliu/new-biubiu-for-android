 ...
 */
public class ArrayAdapterCompat<T> extends BaseAdapter implements Filterable {
    /**
     * Contains the list of objects that represent the data of this ArrayAdapterCompat.
    ...
    private View createViewFromResource(int position, View convertView, ViewGroup parent,
        ...
        try {
            ...
            Log.e("ArrayAdapterCompat", "You must supply a resource ID for a TextView");
            throw new IllegalStateException(
                    "ArrayAdapterCompat requires the resource ID to be a TextView", e);
        }
    ...
    /**
     * Creates a new ArrayAdapterCompat from external resources. The content of the array is
     ...
     *
     * @return An ArrayAdapterCompat<CharSequence>.
     */
    public static ArrayAdapterCompat<CharSequence> createFromResource(Context context,
                                                                int textArrayResId, int textViewResId) {
        CharSequence[] strings = context.getResources().getTextArray(textArrayResId);
        return new ArrayAdapterCompat<CharSequence>(context, textViewResId, strings);
    }
